grammar gra; //gramatica C++14

//obtenida de https://github.com/antlr/grammars-v4/blob/master/cpp/CPP14.g4
/*
COSAS QUE HAY QUE SABER

- en la linea 1224 se cambió 'False' por 'Falso' por conflicto con java
  el error fue: "symbol False conflicts with generated code in target language or runtime"
- en la linea 1364 se cambió 'True' por 'Verdadero' por conflicto con java
  el error fue el mismo
- en la linea 1859 y 1860 se usaban 'True' y 'False' se cambiaron por sus
  reemplazos 'Verdadero' y 'Falso' para evitar el mismo error
*/
...
labeledstatement
   : attributespecifierseq? Identifier ':' statement                 #mi_identifier
   | attributespecifierseq? caseconstant ':' statement               #mi_case
   | attributespecifierseq? Default ':' statement                    #mi_default
   ;
...
selectionstatement
   : If '(' condition ')' statement                  #mi_if
   | If '(' condition ')' statement paraelse         #mi_ifelse
   | switchtemp statement                            #mi_switch
   ;
paraelse
   : Else statement
   ;
...
iterationstatement
   : While '(' para_mi_while                                                #mi_while
   | Do statement While '(' expresion_do_while                              #midowhile
   | For '(' forinitstatement para_mi_for                                   #mifor
   | For '(' forrangedeclaration ':' forrangeinitializer ')' statement      #miforeach
   ;
...
Falso //en la original es con 'e False' pero hay problema de conflicto con java
   : 'false'
   ;
...
Verdadero //en el original es 'True' pero hay conflicto con java
   : 'true'
   ;
